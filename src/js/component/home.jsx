		...
		<div>
			...
			<div className="container">
				...
				<div className="row mt-4">
					...
					boton={<Boton direccion="https://4geeks.com/"/>}/>
					...
					boton={<Boton direccion="https://www.istockphoto.com/es/fotos/perro-salchicha"/>}/>
					...
					boton={<Boton direccion="https://es.react.dev/"/>}/>

					<Carta fondo="tarjeta" 
					titulo="Le da estilo" 
					texto="Todos los estilos que ves en esta página fueron sacados de los predefinidos de bootstrap quien nos da infinitas posibilidades de estilos, ¿Quieres verlo?." 
					aligment="text-center" col="mb-3 mb-md-0 col-lg-3" 
					footer="border-top justify-content-center d-flex pieCarta" 
					...
					boton={<Boton direccion="https://getbootstrap.com/"/>}
					/>
				</div>
			</div>
			<footer>
